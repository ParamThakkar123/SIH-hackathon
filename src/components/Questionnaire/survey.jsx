...
const Survey = () => {
  return (
    ...
    <div className='font-sans bg-gray-900 text-white'>
        <h1 className='capitalize text-center text-3xl pt-14'>take the mental health test</h1>
          <div class="px-14 py-14 flex flex-wrap">

            <div class="p-4 lg:w-1/3">
              <div class=" bg-indigo-500 h-96 hover:bg-white hover:text-indigo-500 duration-500 rounded-lg px-10 py-10 relative ">
