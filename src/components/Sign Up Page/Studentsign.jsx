  ...
  return (
    <div className='flex justify-center'>
      ...
      <form method='POST'>
        ...
        <input className='text-2xl px-4 py-2 bg-gray-200 block rounded-3xl w-full m-3' type="text" name='age' placeholder='Your Age'/>
        <input className='text-2xl px-4 py-2 bg-gray-200 block rounded-3xl w-full m-3' type="text" name='number' placeholder='Your Contact Number'/>
